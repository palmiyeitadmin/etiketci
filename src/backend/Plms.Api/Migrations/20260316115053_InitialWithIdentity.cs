        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReadinessSnapshot = table.Column<string>(type: "text", nullable: true),
                    OperatorReviewedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    OperatorReviewedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
