...
export function normalizeElement(rawElement: Partial<LabelElement>, index: number): LabelElement {
  ...
  const merged = {
    ...
    groupId: typeof rawElement.groupId === "string" && rawElement.groupId ? rawElement.groupId : undefined,
    groupName: typeof rawElement.groupName === "string" && rawElement.groupName ? rawElement.groupName : undefined,
